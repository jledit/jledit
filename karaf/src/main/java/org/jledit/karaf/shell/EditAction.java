...
package org.jledit.karaf.shell;
...
@Command(scope = "shell", name = "edit", description = "Opens a text editor")
    ...
    protected Object doExecute() throws Exception {
        ...
        if (!u.getProtocol().equals("file")) {
            ...
            try {
                ...
                System.out.println("Failed to open " + url + " for reading.");
                return null;
            }
            try {
                os = connection.getOutputStream();
            } catch (IOException ex) {
                System.out.println("Failed to open " + url + " for writing.");
                return null;
            }
            ...
            try {
                ...
                System.out.println("Failed to copy resource from url:" + url + " to tmp file: " + path + "  for editing.");
            } finally {
